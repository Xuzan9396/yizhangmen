...
class UserOperator
{
    ...
    public function get($data=array()){
        ...
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_GET_USER_INFO'],$data);
    }
    public function set($data=array()){
        $data['apikey'] = $this->apikey;
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_SET_USER_INFO'],$data);
    }
}
?>