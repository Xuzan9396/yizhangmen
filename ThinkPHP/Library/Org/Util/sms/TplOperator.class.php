...
class TplOperator
{
    ...
    public function get_default($data = array())
    {
        ...
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_GET_DEFAULT_TEMPLATE'], $data);
    }
    public function get($data = array())
    {
        $data['apikey'] = $this->apikey;

        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_GET_TEMPLATE'], $data);
    }
    ...
    public function add($data = array())
    {
        ...
        $data['apikey'] = $this->apikey;
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_ADD_TEMPLATE'], $data);
    }
    ...
    public function upd($data = array())
    {
        ...
        if (!array_key_exists('tpl_content',$data))
            return new Result(null,$data,null,$error = 'tpl_content 为空');
        $data['apikey'] = $this->apikey;
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_UPD_TEMPLATE'], $data);
    }
    ...
    public function del($data = array())
    {
        ...
        return \Org\Util\sms\HttpUtil::PostCURL($this->yunpian_config['URI_DEL_TEMPLATE'], $data);
    }
