<?php
	...
	class SmsController extends CommonController
	{
		...
		protected function loadConfig()
		{
			...
			//APIKEY
			$yunpian_config['APIKEY'] = "cf74772bd560e408e878dfb5a3e94601";
			...
			C('YUNPIAN_CONFIG',$yunpian_config);
		}

		/**
         * smtp邮件发送服务
         * @author YangJun < 15818708414@163.com >
         * @param array [tomail,title,content] 发送目标,邮件标题,邮件内容
         * @return boolean 发送成功或失败 true/false
         */
